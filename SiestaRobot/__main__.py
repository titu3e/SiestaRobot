...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an anime-theme management bot [✨](https://images6.alphacoders.com/117/1178624.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="➗ Add Siesta To Your Group ➗", url="t.me/Tsukasa_Yuzaki_Robot?startgroup=new"),
    ],
]
...
EMI_IMG = "https://images.alphacoders.com/117/1179029.png"
...
def siesta_about_callback(update, context):
    ...
    if query.data == "siesta_":
        query.message.edit_text(
            text="๏ I'm *Tsukasa*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_Tsukasa's licensed under the GNU General Public License v3.0_"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Dev", url="https://t.me/sungjinwooarc"),
                 ],
                 [
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, Tsukasa Robot now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            ...
            "\nJoin My Support Group/Channel for see or report a problem on Tsukasa.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="https://t.me/sctbots"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/sctbots"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="siesta_"),
        ...
        query.message.edit_text(
            text=f"๏ Credis for Tsukasa\n"
            "\nHere Developers Making And Give Inspiration For Made The Siesta Robot",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Sung Jin woo", url="https://t.me/sungjinwooarc"),
                    InlineKeyboardButton(text="⸙ꠋꠋ᭄ HARSHA ✓™", url="https://t.me/harshahero"),
                 ],
                 [
